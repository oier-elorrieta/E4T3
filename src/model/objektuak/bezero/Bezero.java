...
public abstract class Bezero {
     ...
     */
    public Bezero(int id, String izena, String abizena, String hizkuntza, 
                  String erabiltzaileIzena, String pasahitza, Date jaioteguna, 
                  Date erregistroEguna) {
        this.id = id;
        this.izena = izena;
    ...
    /**
     * Bezero bat sortzen du izenarekin, abizenarekin, hizkuntzarekin,
     * erabiltzaile izenarekin, pasahitzarekin, jaiotegunarekin,
     * eta erregistro egunarekin, identifikadore barik.
     * 
     * @param izena Bezeroaren izena
     * @param abizena Bezeroaren abizena
     * @param hizkuntza Bezeroaren hizkuntza
     ...
     * @param erregistroEguna Bezeroaren erregistro eguna
     */
    public Bezero(String izena, String abizena, String hizkuntza, 
                  String erabiltzaileIzena, String pasahitza, Date jaioteguna, 
                  Date erregistroEguna) {
        this.izena = izena;
        this.abizena = abizena;
    ...
    public String toString() {
        return "Bezero [izena=" + izena + ", abizena=" + abizena + ", hizkuntza=" 
            + hizkuntza + ", erabiltzaileIzena=" + erabiltzaileIzena + ", pasahitza=" 
            + pasahitza + ", jaioteguna=" + jaioteguna + ", erregistroEguna=" + erregistroEguna + "]";
    }
    ...
    public boolean equals(Object obj) {
        ...
        return Objects.equals(izena, other.izena) 
            ...
            && Objects.equals(jaioteguna, other.jaioteguna) 
