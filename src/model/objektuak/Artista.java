...
public abstract class Artista {
    ...
    /**
     * Artista identifikadorearekin, izen artistikoarekin, irudiarekin eta deskribapenarekin sortzen du.
     * 
    ...
    public String toString() {
        return "Artista [id=" + id + ", izen_Artistikoa=" + izen_Artistikoa 
               + ", irudia=" + irudia + ", deskribapena=" + deskribapena 
